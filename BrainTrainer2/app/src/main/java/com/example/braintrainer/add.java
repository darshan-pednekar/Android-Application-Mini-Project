...
//        wrongAns = MediaPlayer.create(add.this, R.raw.incorrect);
//        rightAns = MediaPlayer.create(add.this, R.raw.correct);
        ...
        countDownTimer = new CountDownTimer(30000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                remainingTimeLeft.setText(timeLeft + "s");
    ...
    public void answeredRight(){
        ...
        rightAnswers++;
        totalAnswers++;
        score.setText(rightAnswers + "/" + totalAnswers);
//        rightAns.seekTo(0);
//        rightAns.start();
        nextQuestion();
...
//        wrongAns.start();
    ...
    public void nextQuestion(){
        ...
        final int random = new Random().nextInt(k); //nextInt(61) --> [0, 60] + 20 => [20, 80]

        a = random;

        final int random2 = new Random().nextInt((k + 10)) ;
...
//    public void nextPossibleAnswers(){
//
//    }
